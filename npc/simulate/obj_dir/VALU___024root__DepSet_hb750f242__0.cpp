...
VL_INLINE_OPT void VALU___024root___ico_sequent__TOP__0(VALU___024root* vlSelf) {
    ...
    if ((1U & (~ ((IData)(vlSelf->op) >> 2U)))) {
        if ((1U & (~ ((IData)(vlSelf->op) >> 1U)))) {
            vlSelf->carryflag = (1U & ((1U & (IData)(vlSelf->op))
                                        ? (1U & (((IData)(1U) 
                                                  + 
                                                  ((IData)(vlSelf->a) 
                                                   + 
        ...
        if ((2U & (IData)(vlSelf->op))) {
            if ((1U & (IData)(vlSelf->op))) {
                vlSelf->out = (((IData)(vlSelf->a) 
                        ...
                        == (1U & ((IData)(vlSelf->b) 
                                  >> 3U)))) {
                vlSelf->out = (((7U & (IData)(vlSelf->a)) 
                                < (7U & (IData)(vlSelf->b)))
                                ? 1U : 0U);
            } else if ((8U & (IData)(vlSelf->a))) {
                if ((8U & (IData)(vlSelf->a))) {
                    vlSelf->out = 1U;
                }
            } else {
                vlSelf->out = 0U;
        ...
        vlSelf->overflow = (((1U & ((IData)(vlSelf->a) 
                            ...
                            & ((1U & ((IData)(vlSelf->out) 
                                      >> 3U)) != (1U 
                                                  & ((IData)(vlSelf->a) 
                                                     >> 3U))));
        vlSelf->zeroflag = ((0U == (7U & (IData)(vlSelf->out)))
                             ? 1U : 0U);
    } else {
...
#endif
                VL_FATAL_MT("/home/panmy/ysyx-workbench/npc/vsrc/ALU.v", 1, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("/home/panmy/ysyx-workbench/npc/vsrc/ALU.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/panmy/ysyx-workbench/npc/vsrc/ALU.v", 1, "", "NBA region did not converge.");
            }
