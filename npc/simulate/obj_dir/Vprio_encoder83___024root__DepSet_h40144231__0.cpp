...
VL_INLINE_OPT void Vprio_encoder83___024root___ico_sequent__TOP__0(Vprio_encoder83___024root* vlSelf) {
    ...
    vlSelf->led = ((0x40U & ((~ (IData)(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__a)) 
                             << 6U)) | ((0x20U & ((~ (IData)(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__bb)) 
                                                  << 5U)) 
                                        | ((0x10U & 
                                            ((~ (IData)(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__c)) 
                                             << 4U)) 
                                           | ((8U & 
