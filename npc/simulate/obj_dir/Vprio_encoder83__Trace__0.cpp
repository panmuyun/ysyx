...
void Vprio_encoder83___024root__trace_chg_sub_0(Vprio_encoder83___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgBit(oldp+0,(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__a));
        bufp->chgBit(oldp+1,(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__bb));
        bufp->chgBit(oldp+2,(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__c));
        bufp->chgBit(oldp+3,(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__d));
        bufp->chgBit(oldp+4,(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__e));
        bufp->chgBit(oldp+5,(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__f));
        bufp->chgBit(oldp+6,(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__g));
    }
    bufp->chgCData(oldp+7,(vlSelf->x),8);
    bufp->chgBit(oldp+8,(vlSelf->en));
    bufp->chgCData(oldp+9,(vlSelf->encode_x),3);
    bufp->chgBit(oldp+10,(vlSelf->flag));
    bufp->chgCData(oldp+11,(vlSelf->led),7);
    bufp->chgCData(oldp+12,(vlSelf->encode_x),4);
}
