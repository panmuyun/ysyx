...
VL_ATTR_COLD void Vprio_encoder83___024root__trace_init_sub__TOP__0(Vprio_encoder83___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->declBus(c+9,"x", false,-1, 7,0);
    tracep->declBit(c+10,"en", false,-1);
    tracep->declBus(c+11,"encode_x", false,-1, 2,0);
    tracep->declBit(c+12,"flag", false,-1);
    tracep->declBus(c+13,"led", false,-1, 6,0);
    ...
    tracep->declBus(c+13,"h", false,-1, 6,0);
    tracep->declBit(c+2,"a", false,-1);
    tracep->declBit(c+3,"bb", false,-1);
    tracep->declBit(c+4,"c", false,-1);
    tracep->declBit(c+5,"d", false,-1);
    tracep->declBit(c+6,"e", false,-1);
...
VL_ATTR_COLD void Vprio_encoder83___024root__trace_full_sub_0(Vprio_encoder83___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullIData(oldp+1,(vlSelf->prio_encoder83__DOT__i),32);
    bufp->fullBit(oldp+2,(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__a));
    bufp->fullBit(oldp+3,(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__bb));
    bufp->fullBit(oldp+4,(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__c));
    bufp->fullBit(oldp+5,(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__d));
    bufp->fullBit(oldp+6,(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__e));
    bufp->fullBit(oldp+7,(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__f));
    bufp->fullBit(oldp+8,(vlSelf->prio_encoder83__DOT__u_bcd7seg__DOT__g));
    bufp->fullCData(oldp+9,(vlSelf->x),8);
    bufp->fullBit(oldp+10,(vlSelf->en));
    bufp->fullCData(oldp+11,(vlSelf->encode_x),3);
    bufp->fullBit(oldp+12,(vlSelf->flag));
    bufp->fullCData(oldp+13,(vlSelf->led),7);
    bufp->fullCData(oldp+14,(vlSelf->encode_x),4);
}
